...
@section('content')
    ...
    @endif
          ...
          <div class="box box-default">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method='post' action='{{ route('films.store') }}' enctype="multipart/form-data" class="form-horizontal">
            @csrf
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_kategori">
                    ...
                    <!-- <input class="typeahead form-control" type="text" name="id_kategori"> -->
                  </div>
                </div>                
                <div class="form-group">
