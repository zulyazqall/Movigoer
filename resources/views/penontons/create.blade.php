...
@section('content')
    ...
    @endif
          ...
          <div class="box box-default">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method='post' action='{{ route('penontons.store') }}' class="form-horizontal">
            @csrf
              
              <div class="box-body">

              <input type="hidden" class="form-control" id="id_bioskop" name="id_bioskop" value="{{Auth::user()->id}}">
              <input type="hidden" class="form-control" id="user" name="user" value="{{Auth::user()->name}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="typeahead2 form-control" name="film">
                  </div>
                </div> 
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <!-- <input data-provide="typeahead" class="typeahead form-control" type="text" name="kategori"> -->
                    <input class="form-control" type="text" name="kategori" id="kat">
                  </div>
                </div>               
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tgl_tayang" id="datepicker">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="jml_penonton">
                  </div>
                </div>
                <!-- <div class="form-group">
